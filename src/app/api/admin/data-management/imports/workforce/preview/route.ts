...
import { dryRunWorkforceMaster } from "@/lib/data-management/import-workforce-master";
...
/** Dry run — parses the uploaded file and validates/classifies every row. NO database writes (mission section 33/17). */
export async function POST(req: Request) {
  ...
  const result = await dryRunWorkforceMaster(rows);
