...
4. `migrations/2026-08-17-dang-ky-tap-nghe-html-draft.sql` — seed version **v1 DRAFT** của Dang_ky_Tap_nghe (htmlBody/printCss lấy từ template.ts — không transcription tay), `html_enabled=true`; **KHÔNG publish**.
