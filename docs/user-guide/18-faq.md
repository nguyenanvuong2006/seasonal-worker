...
Nếu bạn là Quản lý bộ phận (`DEPT_MANAGER`), bạn chỉ xem được (các) bộ phận được Admin gán riêng cho tài khoản của mình tại Data Scope. `ADMIN` và `HR_RECRUITER` luôn xem toàn bộ. Xem [chương 10](./10-permissions-data-scope.md).
...
**5. Người tập nghề cũ quay lại làm việc thì hồ sơ của họ ra sao?**
Hệ thống tự nhận diện qua CCCD/tên+năm sinh/tên+SĐT và **gắn vào đúng Hồ sơ Tập nghề (Internship Profile) cũ** — không tạo người mới. Xem [chương 5](./05-dw-data-worker-profile.md).
...
**7. Planning có cho phép tạo nhiều kế hoạch trùng thời gian không?**
Có. Hệ thống cho phép tạo một **Kế hoạch gốc** và nhiều **Yêu cầu bổ sung** (Bổ sung 1, Bổ sung 2...) trong cùng một khoảng thời gian cho một bộ phận. Số lượng Cần tuyển được tính tự động phân tách theo Nam và Nữ. Xem [chương 7](./07-planning.md).

**8. Tôi có thể xuất Excel toàn bộ dữ liệu hệ thống không?**
...
**9. Vì sao CCCD/SĐT trong file Excel xuất ra bị ẩn (hiện dấu chấm)?**
...
**10. Tài khoản của tôi bị khoá thì có mất dữ liệu lịch sử không?**
Không. Khoá tài khoản chỉ chặn đăng nhập — mọi hành động đã thực hiện trước đó vẫn được giữ nguyên trong Nhật ký hệ thống.

**11. Tôi có thể dùng chung một tài khoản với đồng nghiệp không?**
...
**12. Người đăng ký Tập nghề có tự xem được lịch sử làm việc của mình không?**
Không có tính năng đăng nhập cho người đăng ký. Họ chỉ tra cứu được **kết quả xếp việc hôm nay và tổng số lần đăng ký** qua trang Tra cứu công khai — không xem được toàn bộ hồ sơ nội bộ.

**13. Kênh thông báo Zalo/SMS/Email đã hoạt động chưa?**
...
**14. Tôi có thể khôi phục hệ thống về đúng một ngày trong quá khứ không?**
...
**15. Vì sao hồ sơ tôi vừa duyệt lại đổi từ nhãn "MỚI" sang "CŨ"?**
...
**16. Tôi có thể xem được mật khẩu của tài khoản khác không?**
