...
| **Nhập sai CCCD** | Gõ tay thay vì quét QR, nhập thiếu hoặc không đúng 12 chữ số | Sửa trực tiếp tại DW Data hoặc Daily Application nếu phát hiện sớm — hệ thống sẽ tự đồng bộ lại các hồ sơ liên quan sang CCCD đúng. Luôn kiểm tra kỹ trước khi duyệt hàng loạt |
